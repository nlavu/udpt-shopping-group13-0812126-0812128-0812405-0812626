<?php
	...
	$dsSuKien = SuKienDAO::LayDanhSachSuKienTheoGianHang('3');
...
<?php 
	...
	else
	{
		...
		$strOutput .="
			  <tr valign='top'>
				<td width='21%'>
					<a href='chi_tiet_su_kien.php?id=$suKienDto->MaSuKien'>
					<img src='$suKienDto->HinhAnh' width='150' height='167' />
					</a>
				</td>
				<td width='76%'>
					<div class='text-color-normal-1'>
						<a href='chi_tiet_su_kien.php?id=$suKienDto->MaSuKien'>".$suKienDto->TenSuKien."</a>
					</div>
					...
					<div class='text-normal-2'>
						<br /><a href='chi_tiet_su_kien.php?id=$suKienDto->MaSuKien'>Xem chi tiết >></a>
					</div>
				</td>
				<td width='3%'>&nbsp;</td>
			  </tr>";
