<div class="top-shop">
          ...
          <div class="top-shop-info">
          	<div class="top-shop-info-line">
            	<div class="name"><a href="#">Content for  class "top-shop-name" Goes Here</a></div>           		
            </div>
            ...
            <div class="top-shop-info-line">            	
           		<div class="views">1000 lượt xem </div>
        ...
        <div class="list-top-shop-wrapper">
       	  <div class="list-top-shop-item">
   		  	<a href="#"><img src="image/flower.jpg" width="80" height="80" class="reflect" /></a>
          </div>
          <!--end .list-top-shop-item-->
           <div class="list-top-shop-item">
   		  	<img src="image/flower.jpg" width="80" height="80" class="reflect" />       
          </div>
          <!--end .list-top-shop-item-->
           <div class="list-top-shop-item">
   		  	<img src="image/flower.jpg" width="80" height="80" class="reflect" />       
