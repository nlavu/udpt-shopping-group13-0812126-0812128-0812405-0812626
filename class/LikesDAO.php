 ...
 */
 class LikesDAO extends ConnectDB {
	...
	// lấy ds theo mã đối tượng
 	public  static  function LayDanhSachLikesTheoMaDoiTuong($maDoiTuong)
	{
		$lstLikes = array();
		try {
	...
	// lấy like theo mã đối tượng & mã người dùng
 	public  static  function LayDanhSachLikesTheoMaDT_MaNguoiDung($maDoiTuong, $maNguoiDung)
	{
		$likesDto = new LikesDTO();
		try {
			if (!ConnectDB::OpenConnection())
	...
	//19/6/2011
	// Tính số sao trung bình theo mã đối tượng
