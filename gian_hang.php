  ...
  <div class="content-shop">
    <div class="content-left">   	  
      	...
      	<div class="right">
            ...
            <?php require_once('controls/ucSuKienNoiBat_Shop.php') ?>
                
        	<?php require_once('controls/ucSanPhamMoi_Shop.php') ?>
            <!--end .top-product || mới nhất-->
        	<?php require_once('controls/ucSanPhamViewCao_Shop.php') ?>
            <!--end .top-product || view cao-->
        </div>
	 </div>
     <!--end .content-left-->
